		...
		const comercialIndicadores: KPIIndicator[] = [
			{
				...
				unidad: 'clientes',
				meta: 15,
				tendencia: this.getTrendencia(this.clientesActuales(), 0),
			...
			},
			{
				...
				unidad: 'clientes',
				meta: 8,
				tendencia: this.getTrendencia(this.clientesNuevos(), 0),
			...
			},
			{
				...
				unidad: 'clientes',
				meta: 5,
				tendencia: this.getTrendencia(this.clientesRepetitivos(), 0),
			...
			},
			{
				...
				unidad: 'clientes/día',
				meta: 1.0,
				tendencia: this.getTrendencia(this.clientesPromedioDiario(), 0),
			...
			},
			{
				...
				unidad: '%',
				meta: 40,
				tendencia: this.getTrendencia(this.tasaRetencionClientes(), 0),
